...
EXERCISES = [
    ...
    {"name": "Flat Dumbbell Bench Press", "primary_pattern": ExercisePattern.PUSH},
    {"name": "Incline Dumbbell Press", "primary_pattern": ExercisePattern.PUSH},
    {"name": "Incline Smith Machine Bench Press", "primary_pattern": ExercisePattern.PUSH},
    {"name": "Chest Press Machine", "primary_pattern": ExercisePattern.PUSH},
    {"name": "Neutral-Grip Chest Press Machine", "primary_pattern": ExercisePattern.PUSH},
    {"name": "Cable Fly", "primary_pattern": ExercisePattern.PUSH},
    {"name": "Pec Deck Fly", "primary_pattern": ExercisePattern.PUSH},
    {"name": "Seated Dumbbell Shoulder Press", "primary_pattern": ExercisePattern.PUSH},
    {"name": "Shoulder Press Machine", "primary_pattern": ExercisePattern.PUSH},
    {"name": "Lateral Raise", "primary_pattern": ExercisePattern.PUSH},
    {"name": "Wide-Grip Cable Upright Row", "primary_pattern": ExercisePattern.PUSH},
    ...
    {"name": "Chest-Focused Dips", "primary_pattern": ExercisePattern.PUSH},
    ...
    {"name": "Single-Arm Cable Row", "primary_pattern": ExercisePattern.PULL},
    {"name": "Barbell Row", "primary_pattern": ExercisePattern.PULL},
    {"name": "Dumbbell Row", "primary_pattern": ExercisePattern.PULL},
    {"name": "Straight-Arm Pulldown", "primary_pattern": ExercisePattern.PULL},
    {"name": "Face Pull", "primary_pattern": ExercisePattern.PULL},
    {"name": "Reverse Pec Deck", "primary_pattern": ExercisePattern.PULL},
    ...
    {"name": "Cable Curl", "primary_pattern": ExercisePattern.PULL},
    {"name": "Single-Arm Cable Curl", "primary_pattern": ExercisePattern.PULL},
    {"name": "Preacher Curl", "primary_pattern": ExercisePattern.PULL},
    {"name": "Dumbbell Shrug", "primary_pattern": ExercisePattern.PULL},

    # Legs
    {"name": "Barbell Squat", "primary_pattern": ExercisePattern.LEGS},
    {"name": "Front Squat", "primary_pattern": ExercisePattern.LEGS},
    ...
    {"name": "Deadlift", "primary_pattern": ExercisePattern.LEGS},
    ...
    {"name": "Bulgarian Split Squat", "primary_pattern": ExercisePattern.LEGS},
    {"name": "Weighted Back Extension", "primary_pattern": ExercisePattern.LEGS},
    {"name": "Standing Calf Raise", "primary_pattern": ExercisePattern.LEGS},
    {"name": "Seated Calf Raise", "primary_pattern": ExercisePattern.LEGS},
    {"name": "Hip Abduction Machine", "primary_pattern": ExercisePattern.LEGS},
    {"name": "Hip Adduction Machine", "primary_pattern": ExercisePattern.LEGS},
